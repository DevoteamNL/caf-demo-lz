resource "azurerm_mssql_server" "mssql" {
  ...
  dynamic "azuread_administrator" {
    ...
    content {
      ...
      login_username              = try(var.settings.azuread_administrator.login_username, null )
      object_id                   = try(var.settings.azuread_administrator.object_id, null)
...
resource "azurerm_mssql_server_transparent_data_encryption" "tde" {
  ...
  server_id        = azurerm_mssql_server.mssql.id
  key_vault_key_id = var.settings.transparent_data_encryption.encryption_key
}